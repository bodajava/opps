...
describe('Auth registration (E2E)', () => {
  ...
  it('registers a new account, sends verification OTP, and then logs in', async () => {
  ...
  it('returns a useful duplicate-email response', async () => {
  ...
  it('does not create an account when verification email delivery fails', async () => {
    ...
    await expect(userModel.findOne({ email })).resolves.toBeNull();
  });
});
